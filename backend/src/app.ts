...
import { freekassaWebhooksRouter, handleFreekassaWebhook, freekassaFormParser } from "./modules/webhooks/freekassa.webhooks.routes.js";
...
app.post("/api/kassaai", freekassaFormParser, handleFreekassaWebhook);
