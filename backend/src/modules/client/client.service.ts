...
const SYSTEM_CONFIG_KEYS = [
  ...
  "yoomoney_enabled", "yoomoney_wallet", "yoomoney_notification_secret", "yoomoney_label", "yoomoney_success_url", "yoomoney_fail_url",
...
export async function getSystemConfig() {
  ...
  return {
    ...
    yoomoneyEnabled: map.yoomoney_enabled === "true" || map.yoomoney_enabled === "1",
    yoomoneyWallet: map.yoomoney_wallet || null,
    yoomoneyNotificationSecret: map.yoomoney_notification_secret || null,
    yoomoneyLabel: (map.yoomoney_label || "ЮMoney").trim() || "ЮMoney",
    yoomoneySuccessUrl: map.yoomoney_success_url || null,
    yoomoneyFailUrl: map.yoomoney_fail_url || null,
...
export async function getPublicConfig() {
  ...
  return {
    ...
    yoomoneyEnabled: Boolean(full.yoomoneyEnabled && full.yoomoneyWallet && full.yoomoneyNotificationSecret),
    yoomoneyLabel: full.yoomoneyLabel || "ЮMoney",
    trialEnabled,
    trialDays,
